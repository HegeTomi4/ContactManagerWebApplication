...
namespace SimiiformesWebApplication.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,City,Street,HouseNumber,PostalCode")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,City,Street,HouseNumber,PostalCode")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
